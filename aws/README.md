...
| use_existing_cloudtrail | Set this to `true` to use an existing cloudtrail. When set to `true` you must provide the `bucket_name`, `bucket_arn`, and `sns_topic_name` | `bool` | `false` | no |
